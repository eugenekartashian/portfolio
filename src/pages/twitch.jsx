  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            {/* <img className='absolute z-1' layout='fill' src='../assets/projects/twitch.jpg' alt='/' /> */}
            ...
            <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 dark:shadow-[#131313] rounded-xl p-4'>
              <div className='p-2'>
                ...
                <div className='grid grid-cols-3 md:grid-cols-1'>
                  <p className='py-2 flex items-center'><RiRadioButtonFill className='mr-2'/> Next.JS</p>
                  ...
                  <p className='py-2 flex items-center'><RiRadioButtonFill className='mr-2'/> Next Auth</p>
                  <p className='py-2 flex items-center'><RiRadioButtonFill className='mr-2'/> Github Auth</p>
                  <p className='py-2 flex items-center'><RiRadioButtonFill className='mr-2'/> Google Auth</p>
                </div>
              </div>
            </div>
            <Link to='/projects'>
